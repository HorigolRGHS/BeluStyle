                    ...
                    <ul class="products homepage">
                        <c:forEach var="product" items="${paginatedProducts}">
                            <li class="preorder">
                                ...
                                <a href="detail.jsp?ma_san_pham=${product.ma_san_pham}">
                                    <img src="sanpham/${product.hinh_anh}" width="250px" height="250px" />
                                    <h3>${product.ten_san_pham}</h3>
                                    <h4>
                                        Giá: <fmt:formatNumber value="${product.gia_ban}" type="number" minFractionDigits="0" /> VNĐ
                                    </h4>
                                    <span class="textkm">Khuyến mãi trị giá đến <strong>500.000₫</strong></span>
                                    <p class="info">
                                        <span>Hãng sx: ${product.hang_san_xuat}</span>
                                        <span>Giá: <fmt:formatNumber value="${product.gia_ban}" type="number" minFractionDigits="0" /> VNĐ</span>
                                        <span>Thông tin: ${product.thong_tin}</span>
                                    </p>
                                </a>
                            </li>
                        </c:forEach>
